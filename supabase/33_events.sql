...
(
  ...
  '["경품 지급 방식: 당첨자 경품은 앱 내 ''내 보관함''으로 지급되지 않으며, 제출해주신 구글 폼 연락처를 통해 개별 문자(또는 카카오톡 선물하기)로 직접 발송됩니다.", "보관함 확인 불가: 본 이벤트의 경품은 시스템 연동이 되지 않으므로, 마이페이지의 ''내 보관함''에서는 당첨 내역 및 쿠폰 조회가 불가능한 점 양해 부탁드립니다.", "당첨 취소 조건: 당첨자 발표 후 안내된 기한(통상 7일) 내에 경품 수령 정보를 입력하지 않으실 경우, 당첨이 자동 취소되며 추가 보상은 불가합니다.", "개인정보 활용: 수집된 개인정보는 경품 발송 목적으로만 사용되며, 발송 완료 후 안전하게 파기됩니다."]'::jsonb,
  100,
  50,
  '스타벅스 응모하기',
  NULL,
...
(
  ...
  '뜨거웠던 투표 열기 속에 당첨되신 행운의 주인공 50분을 아래와 같이 발표합니다. 당첨자분께는 개별 문자(또는 카카오톡 선물하기)로 경품이 발송되었습니다.',
  '[]'::jsonb,
  0,
  50,
  '응모하기',

...
(
  ...
  '["경품 지급 안내: 당첨 시 제출해주신 구글 폼 연락처를 통해 개별 문자(또는 카카오톡)로 직접 발송합니다.", "당첨 취소 조건: 당첨자 발표 후 안내된 기한 내에 경품 수령 정보를 입력하지 않으실 경우, 당첨이 자동 취소되며 추가 보상은 불가합니다.", "개인정보 활용: 수집된 개인정보는 경품 발송 목적으로만 사용되며, 발송 완료 후 안전하게 파기됩니다."]'::jsonb,
  100,
  50,
  '스타벅스 응모하기',
  NULL,
